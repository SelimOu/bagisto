...
<footer class="mt-9 bg-lightOrange max-sm:mt-8">
                ...
                >
                    <div class="relative w-full">
                        <x-shop::form.control-group.control
                            type="email"
                            class="blockw-[420px] max-w-full px-5 py-5 p-28 bg-[#FFFFFF] border-[2px] border-[#1B9AE9] rounded-xl text-xs font-medium max-1060:w-full"
                            name="email"
    ...
    <div class="flex justify-between  px-[60px] py-3.5 bg-[#67BCF0]">
